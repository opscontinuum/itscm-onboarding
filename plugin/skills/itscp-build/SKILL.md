...
```
Coverage: 17/92 fields (18%)
  ANSWERED 14 | NOT_APPLICABLE 3 | DEFERRED 2 | MISSING 73
...
Lowest confidence:  business.rpo.tier0 (low) - no measurement, no mechanism given
...
`itscp-method-answer-store` skill, which is 92 fields. They are an illustration of the shape,
...
2. **Count the denominator; never quote one.** It is the number of fields in scope for *this*
   plan, counted from that plan's answer store. The starter set is 92 fields; a plan that adds
