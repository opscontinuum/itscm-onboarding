...
#: ``document:<path>``, naming a document the organization supplied.
...
class Coverage:
    ...
    confidence describes an organization that has guessed comprehensively, so the two
...
def _header() -> str:
    return "\n".join(
        f"# {line}".rstrip() for line in (
            ...
            "numbers, OCIDs, MTD figures and organizational weak points. It is the most",
