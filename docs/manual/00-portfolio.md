...
The five passes are at the foot of this page. Errors are contradictions, not preferences — an RTO
...
Then the systems are planned one at a time, in wave order. The register is the input: it supplies the tier, the targets and the dependencies each plan has
to honor. Walk the checks again after each plan is signed, because a signed plan can change a number
...
Walk the wall against each of these. They are the five passes at the foot of this page,
