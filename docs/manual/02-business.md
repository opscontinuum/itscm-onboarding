...
If the organization has more than one system, the tier budget was set in phase 0
...
the build and you rebuild to numbers you could have known up front. Nothing downstream starts until the output
